 ...
 * @since 1.5.0
 */
@ConfigurationProperties(prefix = "go.kafka")
public class KafkaProperties {
    ...
    public static class Consumer {
        ...
        private Duration sessionTimeout = Duration.ofMillis(200000);
        /**
        ...
        public Map<String, Object> buildProperties() {
            ...
            map.from(this::getSessionTimeout).asInt(Duration::toMillis)
                    .to(properties.in(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG));
    ...
    public static class Producer {
        ...
        private Integer maxRequestSize = 20971520;
        ...
        public Map<String, Object> buildProperties() {
            ...
            map.from(this::getMaxRequestSize)
                    .to(properties.in(ProducerConfig.MAX_REQUEST_SIZE_CONFIG));
            return properties.with(this.ssl, this.properties);
        }
    ...
    public static class Streams {
        ...
        /**
         * Whether or not to auto-startAll the streams factory bean.
         */
        ...
        @DeprecatedConfigurationProperty(replacement = "go.kafka.streams.cache-max-size-buffering")
        @Deprecated
